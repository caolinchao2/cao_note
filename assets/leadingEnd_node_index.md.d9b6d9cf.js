...
<span class="line"><span style="color:#6A737D;">// 当前js文件的路径</span></span>
<span class="line"><span style="color:#24292E;">console.</span><span style="color:#6F42C1;">log</span><span style="color:#24292E;">( __filename );</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><h1 id="cmd命令行" tabindex="-1">CMD命令行 <a class="header-anchor" href="#cmd命令行" aria-label="Permalink to &quot;CMD命令行&quot;">​</a></h1><p>第1种：windows + R -&gt; 输入 cmd -&gt; 敲回车</p><p>第2种：打开任意文件夹 -&gt; 在地址栏输入cmd -&gt; 敲回车</p><p>常用命令</p><p>● cls 清屏</p><p>● dir 列出当前目录下的所有文件</p><p>● cd 进入到指定的目录 cd.. 退回到上一级目录</p><p>● md 创建指定的目录</p><p>● rd 删除一个文件夹（只能删除空文件夹</p><p>● rm 删除文件</p>`,32),o=[e];function r(c,i,t,E,m,y){return n(),a("div",null,o)}const u=s(p,[["render",r]]);export{b as __pageData,u as default};
