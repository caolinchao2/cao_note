import{_ as n,o as a,c as l,O as p}from"./chunks/framework.b55d0e42.js";const y=JSON.parse('{"title":"目录","description":"","frontmatter":{},"headers":[],"relativePath":"leadingEnd/node copy/index.md","filePath":"leadingEnd/node copy/index.md","lastUpdated":1743127905000}'),e={name:"leadingEnd/node copy/index.md"};function o(r,s,c,i,t,E){return a(),l("div",null,s[0]||(s[0]=[p(`<h1 id="目录" tabindex="-1">目录 <a class="header-anchor" href="#目录" aria-label="Permalink to &quot;目录&quot;">​</a></h1><p>官方文档：<a href="http://nodejs.cn/api/" target="_blank" rel="noreferrer">node API 文档</a></p><p><a href="./NpmPackage">一、NpmPackage</a></p><p><a href="./HTTP状态码">一、HTTP 状态码</a></p><p><a href="./http_nodejs">二、http_nodejs</a></p><p><a href="./路由、path、模块">三、路由、path、模块</a></p><p><a href="./fs文件">四、fs 文件</a></p><p><a href="./express_跨域">五、express_跨域</a></p><p><a href="./RESTful、爬虫">六、RESTful、爬虫</a></p><p><a href="./加密_cookie_ejs">七、加密_cookie_ejs</a></p><p><a href="./模板化">八、模板化</a></p><p><a href="./mongodb">九、mongodb</a></p><p><a href="./mongoose">十、mongoose</a></p><p><a href="./websocket">十一、websocket</a></p><p><a href="./node使用babel">十二、node 使用 babel</a></p><p><a href="./node常用指令">十三、node 常用指令</a></p><p><a href="./node插件分享">十四、node 插件分享</a></p><p><a href="./node项目实例">十五、node 项目实例</a></p><p><a href="./node项目小技巧">十六、node 项目小技巧</a></p><h1 id="nvm" tabindex="-1">nvm <a class="header-anchor" href="#nvm" aria-label="Permalink to &quot;nvm&quot;">​</a></h1><div class="language-jsx vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">nvm list available    </span><span style="color:#6A737D;">//查看可安装的版本</span></span>
...
<span class="line"><span style="color:#6A737D;">// 当前js文件的路径</span></span>
<span class="line"><span style="color:#24292E;">console.</span><span style="color:#6F42C1;">log</span><span style="color:#24292E;">(__filename)</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><h1 id="cmd-命令行" tabindex="-1">CMD 命令行 <a class="header-anchor" href="#cmd-命令行" aria-label="Permalink to &quot;CMD 命令行&quot;">​</a></h1><p>第 1 种：windows + R -&gt; 输入 cmd -&gt; 敲回车</p><p>第 2 种：打开任意文件夹 -&gt; 在地址栏输入 cmd -&gt; 敲回车</p><p>常用命令</p><p>● cls 清屏</p><p>● dir 列出当前目录下的所有文件</p><p>● cd 进入到指定的目录 cd.. 退回到上一级目录</p><p>● md 创建指定的目录</p><p>● rd 删除一个文件夹（只能删除空文件夹</p><p>● rm 删除文件</p>`,33)]))}const b=n(e,[["render",o]]);export{y as __pageData,b as default};
