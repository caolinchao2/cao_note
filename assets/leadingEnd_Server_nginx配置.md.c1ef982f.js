import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.b5309610.js";const u=JSON.parse('{"title":"nginx配置","description":"","frontmatter":{},"headers":[],"relativePath":"leadingEnd/Server/nginx配置.md","filePath":"leadingEnd/Server/nginx配置.md","lastUpdated":null}'),l={name:"leadingEnd/Server/nginx配置.md"},e=p(`<h1 id="nginx配置" tabindex="-1">nginx配置 <a class="header-anchor" href="#nginx配置" aria-label="Permalink to &quot;nginx配置&quot;">​</a></h1><h2 id="搭建静态站点" tabindex="-1">搭建静态站点 <a class="header-anchor" href="#搭建静态站点" aria-label="Permalink to &quot;搭建静态站点&quot;">​</a></h2><div class="language-nginx vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">nginx</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 虚拟主机server块</span></span>
