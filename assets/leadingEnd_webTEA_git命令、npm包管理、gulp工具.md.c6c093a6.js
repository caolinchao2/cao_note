import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.d7c6e0b6.js";const m=JSON.parse('{"title":"git命令、npm包管理、gulp工具","description":"","frontmatter":{},"headers":[],"relativePath":"leadingEnd/webTEA/git命令、npm包管理、gulp工具.md","filePath":"leadingEnd/webTEA/git命令、npm包管理、gulp工具.md","lastUpdated":1743127905000}'),l={name:"leadingEnd/webTEA/git命令、npm包管理、gulp工具.md"},e=p(`<h1 id="git命令、npm包管理、gulp工具" tabindex="-1">git命令、npm包管理、gulp工具 <a class="header-anchor" href="#git命令、npm包管理、gulp工具" aria-label="Permalink to &quot;git命令、npm包管理、gulp工具&quot;">​</a></h1><h2 id="git操作" tabindex="-1">git操作 <a class="header-anchor" href="#git操作" aria-label="Permalink to &quot;git操作&quot;">​</a></h2><h3 id="git常规操作" tabindex="-1">git常规操作 <a class="header-anchor" href="#git常规操作" aria-label="Permalink to &quot;git常规操作&quot;">​</a></h3><div class="language-git vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">git</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;"># 查看状态</span></span>
...
<span class="line"><span style="color:#24292E;">   </span><span style="color:#6F42C1;">git</span><span style="color:#24292E;"> </span><span style="color:#032F62;">rebase</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">-i</span><span style="color:#24292E;"> </span><span style="color:#032F62;">HEAD~N</span><span style="color:#24292E;">  </span><span style="color:#6A737D;"># N 是你想要修改的提交数量</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><h2 id="npm包管理工具" tabindex="-1">npm包管理工具 <a class="header-anchor" href="#npm包管理工具" aria-label="Permalink to &quot;npm包管理工具&quot;">​</a></h2><h5 id="npm发布自己的包" tabindex="-1">npm发布自己的包 <a class="header-anchor" href="#npm发布自己的包" aria-label="Permalink to &quot;npm发布自己的包&quot;">​</a></h5><div class="language-javascript vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">注册npm账号：首先需要在npm官网上注册一个账号，可以通过npm adduser命令来进行注册，按照提示输入用户名、密码和邮箱即可。</span></span>
...
<span class="line"><span style="color:#24292E;">发布包时，可以通过npm publish </span><span style="color:#D73A49;">--</span><span style="color:#24292E;">access public命令来将包设置为公开访问，这样其他人就可以通过npm install命令来安装和使用你的包。</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><h5 id="npm包管理工具-1" tabindex="-1">npm包管理工具 <a class="header-anchor" href="#npm包管理工具-1" aria-label="Permalink to &quot;npm包管理工具&quot;">​</a></h5><div class="language-bash vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">在将目录结构创建好以后</span></span>
<span class="line"><span style="color:#B392F0;">1.</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">填写一个git忽略文件</span><span style="color:#E1E4E8;"> </span></span>
...
<span class="line"><span style="color:#B392F0;">3.</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">初始化代码管理工具</span><span style="color:#E1E4E8;"> </span></span>
...
<span class="line"><span style="color:#6F42C1;">1.</span><span style="color:#24292E;"> </span><span style="color:#032F62;">填写一个git忽略文件</span><span style="color:#24292E;"> </span></span>
...
<span class="line"><span style="color:#6F42C1;">3.</span><span style="color:#24292E;"> </span><span style="color:#032F62;">初始化代码管理工具</span><span style="color:#24292E;"> </span></span>
...
<span class="line"><span style="color:#6F42C1;">$</span><span style="color:#24292E;"> </span><span style="color:#032F62;">nrm</span><span style="color:#24292E;"> </span><span style="color:#032F62;">use</span><span style="color:#24292E;"> </span><span style="color:#032F62;">taobao</span><span style="color:#24292E;">       </span><span style="color:#6A737D;"># 切换到taobao镜像</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><h2 id="gulp工具" tabindex="-1">gulp工具 <a class="header-anchor" href="#gulp工具" aria-label="Permalink to &quot;gulp工具&quot;">​</a></h2><h5 id="项目构建" tabindex="-1">项目构建 <a class="header-anchor" href="#项目构建" aria-label="Permalink to &quot;项目构建&quot;">​</a></h5><div class="language-bash vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">Gulp.js</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">是基于nodejs</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">构建的,</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">它利用了Nodejs的流控制能力</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">辅助项目构建.</span></span>
