import{_ as n,o as a,c as e,O as l}from"./chunks/framework.b55d0e42.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"leadingEnd/小程序/工程优化.md","filePath":"leadingEnd/小程序/工程优化.md","lastUpdated":1757501801000}'),p={name:"leadingEnd/小程序/工程优化.md"};function o(c,s,t,r,i,u){return a(),e("div",null,s[0]||(s[0]=[l(`<h2 id="工程优化" tabindex="-1">工程优化 <a class="header-anchor" href="#工程优化" aria-label="Permalink to &quot;工程优化&quot;">​</a></h2><h3 id="分包" tabindex="-1">分包 <a class="header-anchor" href="#分包" aria-label="Permalink to &quot;分包&quot;">​</a></h3><p>某些情况下，开发者需要将小程序划分成不同的子包，在构建时打包成不同的分包，用户在使用时按需进行加载。每个使用分包小程序必定含有一个主包。所谓的主包，即放置默认启动页面/TabBar 页面，以及一些所有分包都需用到公共资源/JS 脚本；而分包则是根据开发者的配置进行划分。</p><p><strong>优势</strong></p><p>1.在小程序启动时，默认会下载主包并启动主包内页面，当用户进入分包内某个页面时，客户端会把对应分包下载下来，下载完成后再进行展示。 2.单个分包/主包大小不能超过 2M,整个小程序所有分包大小不超过 20M,能够将工程大小扩充到 20M 3.对小程序进行分包，可以优化小程序首次启动的下载时间，以及在多团队共同开发时可以更好的解耦协作。</p><h4 id="配置分包结构" tabindex="-1">配置分包结构 <a class="header-anchor" href="#配置分包结构" aria-label="Permalink to &quot;配置分包结构&quot;">​</a></h4><p>开发者通过在 app.json <code>subpackages</code> 字段声明项目分包结构：</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">  &quot;subPackages&quot;: [{</span></span>
...
<span class="line"><span style="color:#24292e;">&lt;template is=&quot;skeleton&quot; wx:if=&quot;{{loading}}&quot;&gt;&lt;/template&gt;</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div>`,32)]))}const q=n(p,[["render",o]]);export{b as __pageData,q as default};
