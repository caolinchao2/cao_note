import{_ as n,o as a,c as l,O as p}from"./chunks/framework.b55d0e42.js";const b=JSON.parse('{"title":"Webpack 专题","description":"","frontmatter":{},"headers":[],"relativePath":"leadingEnd/webTEA/Webpack专题.md","filePath":"leadingEnd/webTEA/Webpack专题.md","lastUpdated":1743127905000}'),e={name:"leadingEnd/webTEA/Webpack专题.md"};function o(c,s,r,t,E,y){return a(),l("div",null,s[0]||(s[0]=[p(`<h1 id="webpack-专题" tabindex="-1">Webpack 专题 <a class="header-anchor" href="#webpack-专题" aria-label="Permalink to &quot;Webpack 专题&quot;">​</a></h1><h2 id="webpack5-和-webpack4-之间重要的区别" tabindex="-1">webpack5 和 webpack4 之间重要的区别 <a class="header-anchor" href="#webpack5-和-webpack4-之间重要的区别" aria-label="Permalink to &quot;webpack5 和 webpack4 之间重要的区别&quot;">​</a></h2><div class="language-javascript vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#79B8FF;">1.</span><span style="color:#E1E4E8;"> 性能改进：webpack5在构建速度和打包体积方面进行了一些优化。它引入了持久缓存，可以减少构建时间。</span></span>
