import{_ as n,o as a,c as e,O as l}from"./chunks/framework.b55d0e42.js";const u=JSON.parse('{"title":"AST 抽象语法树","description":"","frontmatter":{},"headers":[],"relativePath":"otherNote/AST抽象语法树.md","filePath":"otherNote/AST抽象语法树.md","lastUpdated":1779446001000}'),p={name:"otherNote/AST抽象语法树.md"};function r(c,s,o,t,i,d){return a(),e("div",null,s[0]||(s[0]=[l(`<h1 id="ast-抽象语法树" tabindex="-1">AST 抽象语法树 <a class="header-anchor" href="#ast-抽象语法树" aria-label="Permalink to &quot;AST 抽象语法树&quot;">​</a></h1><blockquote><p><strong>⚠️ 提示：本文档使用 <code>recast</code> 库操作 AST。当前更主流的方式是使用 <code>@babel/parser</code> + <code>@babel/traverse</code> + <code>@babel/types</code>，但 <code>recast</code> 的优势在于保留代码格式。两者可互补使用。</strong></p></blockquote><p>官方文档查看链接：<a href="https://developer.mozilla.org/zh-CN/docs/Mozilla/Projects/SpiderMonkey/Parser_API" target="_blank" rel="noreferrer">AST 对象文档</a> 文档参考链接：<a href="https://segmentfault.com/a/1190000016231512" target="_blank" rel="noreferrer">AST 抽象语法树</a> 插件：<code>npm i recast</code>;</p><h2 id="常用方法" tabindex="-1">常用方法 <a class="header-anchor" href="#常用方法" aria-label="Permalink to &quot;常用方法&quot;">​</a></h2><ul><li>解析代码：<code>recast.parse(code)</code></li><li>输出代码：<code>recast.print(ast).code</code></li><li>输出美化代码：<code>recast.prettyPrint(ast, { tabWidth: 2 }).code</code></li><li>读取文件：<code>recast.run(function(ast, printSource) {})</code></li><li>节点遍历：<code>recast.visit(ast, {visitExpressionStatement:function(path){}})</code></li></ul><h2 id="解析代码" tabindex="-1">解析代码 <a class="header-anchor" href="#解析代码" aria-label="Permalink to &quot;解析代码&quot;">​</a></h2><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">const code = \`</span></span>
...
<span class="line"><span style="color:#24292e;">\`</span></span>
<span class="line"><span style="color:#24292e;">const ast = recast.parse(code)</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><h2 id="recast-types-builders-制作模具" tabindex="-1">recast.types.builders 制作模具 <a class="header-anchor" href="#recast-types-builders-制作模具" aria-label="Permalink to &quot;recast.types.builders 制作模具&quot;">​</a></h2><p>用来修改代码，里面包含所有的 AST 工具，AST 可以去<a href="https://developer.mozilla.org/zh-CN/docs/Mozilla/Projects/SpiderMonkey/Parser_API" target="_blank" rel="noreferrer">AST 对象文档</a>查看</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">const {</span></span>
...
<span class="line"><span style="color:#24292e;">    }</span></span>
<span class="line"><span style="color:#24292e;">  })</span></span>
<span class="line"><span style="color:#24292e;">})</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><p>注意：</p><ul><li>想遍历什么就在前面加<code>visit</code></li><li>每个节点遍历必须<code>return false</code>，或者 <code>this.traverse(path)</code>，否则报错；</li><li>遍历中想输出 ast 对象，就使用<code>console.log(node)</code>，想输出 ast 对象对应的源码，可以<code>printSource(node)</code></li><li><code>#!/usr/bin/env node</code> 在所有使用<code>recast.run()</code>的文件顶部都需要加入这一行</li></ul><h2 id="判断-ast-对象类型" tabindex="-1">判断 AST 对象类型 <a class="header-anchor" href="#判断-ast-对象类型" aria-label="Permalink to &quot;判断 AST 对象类型&quot;">​</a></h2><p>TNT，recast.types.namedTypes</p><ul><li><code>TNT.Node.assert(node)</code> 判断 node 不为 Node 时，正确不输出，错误全局报错</li><li><code>TNT.Node.check(node)</code> 判断 node 是否与 Node 一致，Node 为 AST 对象，比如 ExpressionStatement</li></ul><h2 id="实战操作替换" tabindex="-1">实战操作替换 <a class="header-anchor" href="#实战操作替换" aria-label="Permalink to &quot;实战操作替换&quot;">​</a></h2><p>可以使用在线 ast 语法树，输入想要转换的结构，获取对应的节点类型，之后进行替换</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#!/usr/bin/env node</span></span>
