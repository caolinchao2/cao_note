...
<span class="line"><span style="color:#24292e;">高级阶段：引入 K8s + Helm + 蓝绿/金丝雀部署 + 自动化监控回滚</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>CI/CD 的核心目标是让软件交付更快、更安全、更可靠。选择合适的技术栈和策略，根据团队成熟度和业务需求逐步演进，是实施 CI/CD 的关键。</p>`,187))])}const A=e(i,[["render",u]]);export{D as __pageData,A as default};
